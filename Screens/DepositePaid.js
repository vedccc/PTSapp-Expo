    ...
    return (
        ...
        <View style={{ height: '100%', backgroundColor: 'white' }}>
            ...
            <View style={styles.profilecontainer}>
                ...
                <Text style={{ color: 'black', fontSize: 23, top: 95, width: 370, left: 55, color: '#606060' }}>Your deposite is outstanding.</Text>

                <Text style={{ color: 'black', fontSize: 13, top: 105, marginHorizontal: 10, color: '#606060' }}>Your contract requires you to pay the specific deposite to the real estate agent's trust account. Please ensure that you make this payment by the due date. Thank you!</Text>
            </View>
        </View>
    )
};
